...
class PlaceModelTest extends TestCase
{
    ...
    /**
     * Test place can be created with NAVER place ID and location data.
     */
    public function test_place_can_be_created_with_location_data(): void
    {
        $place = Place::factory()->create([
            'naver_place_id' => 'naver_123456',
            'name' => 'Tokyo Tower',
    ...
    public function test_place_has_correct_fillable_attributes(): void
    {
        ...
        $this->assertContains('naver_place_id', $fillable);
    ...
    /**
     * Test naver_place_id must be unique.
     */
    public function test_naver_place_id_must_be_unique(): void
    {
        Place::factory()->create(['naver_place_id' => 'naver_unique_123']);
